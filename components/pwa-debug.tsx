...
// Definir la interfaz para el estado debugInfo
interface DebugInfo {
  isHttps: boolean;
...
export function PWADebug() {
  ...
  useEffect(() => {
    ...
    // Actualizar el estado con las verificaciones iniciales
    setDebugInfo((prev) => ({
      ...prev,
      isHttps,
      hasServiceWorker,
    ...
    if (hasServiceWorker) {
      navigator.serviceWorker
        ...
        .then((registration) => {
          setDebugInfo((prev) => ({
            ...prev,
            swRegistration: registration ?? null, // Convertir undefined a null
          }));
        })
        .catch((error) => {
    ...
    if ("serviceWorker" in navigator) {
      navigator.serviceWorker
        ...
        .then((registration) => {
          ...
          setDebugInfo((prev) => ({
            ...prev,
            swRegistration: registration ?? null, // Asegurar que registration no sea undefined
          }));
        })
        .catch((error) => {
