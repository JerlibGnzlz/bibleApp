...
import { Edit, Trash2, AlertTriangle, Search, X, BookOpen } from "lucide-react"
...
export function TaskTable({ onEdit, onPreach }: TaskTableProps) {
                            ...
                            <CardContent className="p-4 pt-0">
                                ...
                                <div className="flex gap-2 mt-3 opacity-100 transition-opacity">
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        className="flex-1 bg-background/50 backdrop-blur-sm border-border/50 hover:bg-primary/10 hover:text-primary hover:border-primary/30"
                                        onClick={() => onPreach(task)}
                                    >
                                        <BookOpen className="h-3.5 w-3.5 mr-1.5" /> Predicar
                                    </Button>
                        ...
                        <TableBody>
                            {sortedTasks.length === 0 ? (
                                ...
                                sortedTasks.map((task) => (
                                    <TableRow
                                        key={task.id}
                                        className="group hover:bg-primary/5 border-b border-border/40 transition-colors"
                                    >
                                            <TableCell>
                                                ...
                                                {task.notes && (
                                                    <div className="text-xs text-muted-foreground truncate max-w-[280px] opacity-70">
                                                        {stripHtml(task.notes)}
                                                    </div>
                                                )}
                                            </TableCell>
